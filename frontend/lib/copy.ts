...
export const EVAL = {
  ...
  FEEDBACK_TAB: '反馈',
  FEEDBACK_TITLE: '用户反馈',
  FEEDBACK_STATS_POSITIVE: '👍',
  FEEDBACK_STATS_NEGATIVE: '👎',
  FEEDBACK_STATS_RATE: '差评率',
  FEEDBACK_FILTER_ALL: '全部',
  FEEDBACK_FILTER_TODAY: '今日',
  FEEDBACK_FILTER_WEEK: '本周',
  FEEDBACK_RATING_POSITIVE: '赞',
  FEEDBACK_RATING_NEGATIVE: '踩',
  FEEDBACK_COMMENT_PLACEHOLDER: '哪里不好?(可选)',
